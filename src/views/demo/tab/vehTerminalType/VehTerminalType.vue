  ...
  data: function () {
    return {
      ...
      gridColumn: [
        ...
        { kind: 'text', prop: 'internalCode', label: this.$t('vehList.internalCode') },
        ...
        { kind: 'text', prop: 'entryTime', label: this.$t('vehList.entryTime'), width: '200px' }
      ],
      gridData: [],
      gridOperation: [
