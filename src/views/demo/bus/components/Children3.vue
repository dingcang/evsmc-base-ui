      ...
      <el-row>
        ...
        <el-col
          ...
          <el-button
            size="mini"
            type="primary"
            @click="addData">add</el-button>
          <el-button
            size="mini"
            type="primary"
            @click="editData">edit</el-button>
          <el-button
            size="mini"
            type="primary"
            @click="removeData">remove</el-button>
          <el-button
            size="mini"
            type="primary"
            @click="clearData">clear</el-button>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="6">
        ...
        <el-col
          ...
          <el-button
            size="mini"
            type="primary"
            @click="setName">setName</el-button>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="6">
          <el-form-item label="sex">
            <el-radio
              v-model="newSex"
              :label="true"
              size="mini">男</el-radio>
            <el-radio
              v-model="newSex"
              :label="false"
              size="mini">女</el-radio>
          </el-form-item>
        </el-col>
        <el-col
          :span="17"
      ...
      <el-row>
        <el-col
          ...
          <el-button
            size="mini"
            type="primary"
            @click="setQueryData">queryData</el-button>
          <el-button
            size="mini"
            type="primary"
            @click="getInfoBy1">getInfoBy1</el-button>
        </el-col>
      </el-row>
    </el-form>
...
<script>
  ...
  const {mapGetters, mapMutations, mapActions} = createNamespacedHelpers('demo')
